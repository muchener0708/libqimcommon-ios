...
- (void)getPublicNavCompanyWithKeyword:(NSString *)keyword withCallBack:(QIMKitgetPublicCompanySuccessedBlock)callback {
    ...
    NSString *destUrl = [NSString stringWithFormat:@"https://im.qunar.com/pubapi/qtalk/domain/search_user_host.qunar?keyword=%@", [[keyword lowercaseString] stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
